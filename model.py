...
class StyleDiscriminator(nn.Module):
    def __init__(self, input_nc):
        ...
        self.avg_pool1 = nn.AdaptiveAvgPool2d(16)
        self.avg_pool2 = nn.AdaptiveAvgPool2d(8)
        self.avg_pool3 = nn.AdaptiveAvgPool2d(4)
        self.avg_pool4 = nn.AdaptiveAvgPool2d(1)

        self.maxpool1 = nn.AdaptiveMaxPool2d(16)
        self.maxpool2 = nn.AdaptiveMaxPool2d(8)
        self.maxpool3 = nn.AdaptiveMaxPool2d(4)
        self.maxpool4 = nn.AdaptiveMaxPool2d(1)
    ...
    def forward(self, x):
        ...
        combine2 = x2 + y2
        x3 = self.avg_pool3(combine2)
        y3 = self.maxpool3(combine2)
        combine3 = x3 + y3
        x4 = self.avg_pool4(combine3)
        y4 = self.maxpool4(combine3)
        x5 = x4.view(x.size()[0], -1)
        y5 = y4.view(y.size()[0], -1)
        z = x5 + y5
